...
from .predict import predict, predict_multiple, convert_to_lite
...
def convert_to_lite_action(command_parser):

    parser = command_parser.add_parser('convert_to_lite')

    def action(args):
        convert_to_lite(args.checkpoints_path)
...
def main():
    ...
    convert_to_lite(command_parser)
